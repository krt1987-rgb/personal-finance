  ...
  template: `
    <div class="page">
      <div class="page-header">
        <h1>Provident Funds (EPF, PPF, VPF, NPS)</h1>
        <div class="button-group">
          <button mat-raised-button color="accent" (click)="importProvidentFunds()">
